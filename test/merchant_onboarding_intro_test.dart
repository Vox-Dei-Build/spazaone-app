...
void main() {
  testWidgets(
    'merchant onboarding intro leads with customer capture',
    (tester) async {
  ...
  testWidgets(
    'Later dismisses the sheet without opening either surface',
    (tester) async {
      var openedCustomers = false;
  ...
  testWidgets(
    'intro copy uses transaction wording, never credit',
    (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
