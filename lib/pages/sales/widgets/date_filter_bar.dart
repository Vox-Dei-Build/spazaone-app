...
class DateFilterBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hPad = SizeConfig.imageSizeMultiplier * 2.5; // ~10–12px
    final vPad = SizeConfig.heightMultiplier * .9; // ~6–8px
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  fontSize: SizeConfig.textMultiplier * 1.6, // ~12–13px
                ),
              ),
            ),
            // Range picker
            ...
            // Quick ranges menu (Today / This Week / This Month / Clear)
